...
export default function Desktop(){ 
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
        ...
        .fromTo(anim1.current,{ scale:1, opacity:0,},{x:0,scale:1,opacity:1})
        .fromTo(item1.current, {opacity:0,x:150, scale:2},{scale:1, y:0,opacity:1,color:'#222', textShadow:'2px 2px 3px black',})
            .to(item1.current,{y:0, x:0 },)
        .fromTo(item2img.current,{opacity:0,},{opacity:1, } )
        .fromTo(item3.current,{opacity:0, x:150},{x:0,opacity:1,color:'#222',zIndex:100, textShadow:'2px 2px 3px black',})



        .fromTo(anim2.current,{scale:1, opacity:0,},{x:0,scale:1,opacity:1, color:'#222', textShadow:'2px 2px 3px black'})
        .fromTo(ynika.current,{opacity:0,y:50,xPercent:0},{opacity:1,color:'#222', textShadow:'2px 2px 3px black',},)
        .fromTo(el.current,{opacity:0,y:0,},{opacity:1,color:'#222', textShadow:'2px 2px 3px black', },'<')
        ...
        .fromTo(ei.current,{opacity:0,x:0},{y:-100,opacity:1,rotationZ:'180deg',color:'red', })
            .to(ei.current,{y:-100,x:0,})

        .fromTo(anim3.current,{ scale:1, opacity:0,},{x:0,scale:1,opacity:1})

        .fromTo(item7.current,{yPercent:0,opacity:0, color:'#222',scale:5},{scale:1,yPercent:0,xPercent:0,opacity:1,textShadow:'2px 2px 4px white',},)
